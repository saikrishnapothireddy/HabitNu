class TasksController < ApplicationController
  ...
  def create
    ...
    todo_tasks_percentage = (todo_tasks_count.to_f / total_tasks_count) * 100

    # Check if the percentage exceeds 50%
    if todo_tasks_percentage >= 50
      respond_to do |format|
        format.html { redirect_to tasks_path, notice: "Many tasks are in To Do status" }
